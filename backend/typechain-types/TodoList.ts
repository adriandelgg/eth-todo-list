...
export interface TodoListInterface extends utils.Interface {
  ...
  events: {
    ...
    "TaskRemoved(uint256)": EventFragment;
  };

  getEvent(nameOrSignatureOrTopic: "TaskCompleted"): EventFragment;
  getEvent(nameOrSignatureOrTopic: "TaskCreated"): EventFragment;
  getEvent(nameOrSignatureOrTopic: "TaskRemoved"): EventFragment;
}

export type TaskCompletedEvent = TypedEvent<[BigNumber], { id: BigNumber }>;
...
export type TaskRemovedEvent = TypedEvent<[BigNumber], { id: BigNumber }>;

export type TaskRemovedEventFilter = TypedEventFilter<TaskRemovedEvent>;
...
export interface TodoList extends BaseContract {
  ...
  filters: {
    "TaskCompleted(uint256)"(id?: null): TaskCompletedEventFilter;
    TaskCompleted(id?: null): TaskCompletedEventFilter;
    ...
    "TaskRemoved(uint256)"(id?: null): TaskRemovedEventFilter;
    TaskRemoved(id?: null): TaskRemovedEventFilter;
  };
